...
namespace osu.Framework.BellaFiora
{
    public class Globals
    {
        ...
        public static readonly double DRAW_THREADS_HZ = 144.03f;
        public static readonly double UPDATE_THREADS_HZ = 144.03f;
        public static readonly double INPUT_THREADS_HZ = 10f;
        public static readonly double AUDIO_THREADS_HZ = 1f;
