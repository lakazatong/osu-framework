...
namespace osu.Framework.BellaFiora
{
    public class Globals
    {
        ...
        public static readonly double UPDATE_THREADS_HZ = 30f; // no impact on Auto gameplay (takes longer to start a map tho)
        public static readonly double INPUT_THREADS_HZ = 10f; // no impact on Auto gameplay
